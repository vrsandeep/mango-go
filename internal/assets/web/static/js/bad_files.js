...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function deleteBadFile(id) {
        if (!confirm('Are you sure you want to remove this entry? This will not delete the actual file.')) {
            return;
        }
    ...
    function downloadCSV() {
        ...
        // Create CSV content
        const headers = ['File Name', 'Path', 'Error', 'File Size (bytes)', 'Detected At', 'Last Checked'];
        const csvContent = [
            headers.join(','),
